...
const HOBBIES = [
  new hobby(
    ...
    \
    When I started University, I was given a Toshiba Satellite Pro L870-13U laptop as part of a student support program. During my studies at Southampton Solent, I surrounded myself with Cyberpunk and Dystopian works like <a href='https://wikiless.org/wiki/Neuromancer' target='_blank'>Neuromancer</a>, <a href='https://wikiless.org/wiki/Blade_Runner' target='_blank'>Blade Runner</a>, <a href='https://wikiless.org/wiki/Ghost_in_the_Shell_(1995_film)' target='_blank'>Ghost in the Shell</a> and <A href='https://wikiless.org/wiki/Nineteen_Eighty-Four' target='_blank'>Nineteen-Eighty Four</a> which piqued my interest in hacking, mass surveillance and online privacy.<br><br>\
    \
