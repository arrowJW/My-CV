...
const HOBBIES = [
  ...
  new hobby(
    ...
    \
    It's thanks to that I rely on a lot of FOSS apps like <a href='https://keepassxc.org/' target='_blank'>KeePassXC</a>, <a href='https://www.veracrypt.fr/code/VeraCrypt/' target='_blank'>VeraCrypt</a> and <a href='https://www.virtualbox.org/' target='_blank'>VirtualBox</a>. I now do most of my browsing, emails and such on a virtual machine running MX Linux, a popular <a href='https://www.debian.org/' target='_blank'>Debian-based</a> distro without <a href=_'https://nosystemd.org/' target='_blank'>systemd</a> - a popular but controversial init software for potential security flaws.<br><br>\
    \
